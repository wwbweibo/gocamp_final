...
func (*GetCartReply_Item) Descriptor() ([]byte, []int) {
	return file_api_cart_v1_cart_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *AddItemReply_Item) Reset() {
	*x = AddItemReply_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_cart_v1_cart_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AddItemReply_Item) Descriptor() ([]byte, []int) {
	return file_api_cart_v1_cart_proto_rawDescGZIP(), []int{5, 0}
}
...
func (x *UpdateItemReply_Item) Reset() {
	*x = UpdateItemReply_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_cart_v1_cart_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateItemReply_Item) Descriptor() ([]byte, []int) {
	return file_api_cart_v1_cart_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *DeleteItemReply_Item) Reset() {
	*x = DeleteItemReply_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_cart_v1_cart_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteItemReply_Item) Descriptor() ([]byte, []int) {
	return file_api_cart_v1_cart_proto_rawDescGZIP(), []int{9, 0}
}
...
var file_api_cart_v1_cart_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x76,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x7d, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72,
	0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x30, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x2e, 0x49, 0x74, 0x65,
	0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x3b, 0x0a, 0x04, 0x49, 0x74, 0x65, 0x6d,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x28, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43,
	...
	0x6c, 0x79, 0x22, 0x5a, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x7d,
	0x0a, 0x0c, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x30,
	0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x63, 0x61, 0x72, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x5d, 0x0a,
	...
	0x28, 0x03, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x83, 0x01, 0x0a,
	0x0f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x12, 0x33, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1d, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x74, 0x79, 0x22, 0x41, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x74, 0x65, 0x6d,
	...
	0x74, 0x65, 0x6d, 0x49, 0x64, 0x22, 0x83, 0x01, 0x0a, 0x0f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x33, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x63, 0x61, 0x72, 0x74, 0x2e,
	...
	,
	...
	,
...
var file_api_cart_v1_cart_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_api_cart_v1_cart_proto_goTypes = []interface{}{
	(*GetCartReq)(nil),           // 0: cart.v1.GetCartReq
	(*GetCartReply)(nil),         // 1: cart.v1.GetCartReply
	(*DeleteCartReq)(nil),        // 2: cart.v1.DeleteCartReq
	(*DeleteCartReply)(nil),      // 3: cart.v1.DeleteCartReply
	(*AddItemReq)(nil),           // 4: cart.v1.AddItemReq
	(*AddItemReply)(nil),         // 5: cart.v1.AddItemReply
	(*UpdateItemReq)(nil),        // 6: cart.v1.UpdateItemReq
	(*UpdateItemReply)(nil),      // 7: cart.v1.UpdateItemReply
	(*DeleteItemReq)(nil),        // 8: cart.v1.DeleteItemReq
	(*DeleteItemReply)(nil),      // 9: cart.v1.DeleteItemReply
	(*GetCartReply_Item)(nil),    // 10: cart.v1.GetCartReply.Item
	(*AddItemReply_Item)(nil),    // 11: cart.v1.AddItemReply.Item
	(*UpdateItemReply_Item)(nil), // 12: cart.v1.UpdateItemReply.Item
	(*DeleteItemReply_Item)(nil), // 13: cart.v1.DeleteItemReply.Item
}
var file_api_cart_v1_cart_proto_depIdxs = []int32{
	10, // 0: cart.v1.GetCartReply.items:type_name -> cart.v1.GetCartReply.Item
	11, // 1: cart.v1.AddItemReply.items:type_name -> cart.v1.AddItemReply.Item
	12, // 2: cart.v1.UpdateItemReply.items:type_name -> cart.v1.UpdateItemReply.Item
	13, // 3: cart.v1.DeleteItemReply.items:type_name -> cart.v1.DeleteItemReply.Item
	0,  // 4: cart.v1.Cart.GetCart:input_type -> cart.v1.GetCartReq
	2,  // 5: cart.v1.Cart.DeleteCart:input_type -> cart.v1.DeleteCartReq
	4,  // 6: cart.v1.Cart.AddItem:input_type -> cart.v1.AddItemReq
	6,  // 7: cart.v1.Cart.UpdateItem:input_type -> cart.v1.UpdateItemReq
	8,  // 8: cart.v1.Cart.DeleteItem:input_type -> cart.v1.DeleteItemReq
	1,  // 9: cart.v1.Cart.GetCart:output_type -> cart.v1.GetCartReply
	3,  // 10: cart.v1.Cart.DeleteCart:output_type -> cart.v1.DeleteCartReply
	5,  // 11: cart.v1.Cart.AddItem:output_type -> cart.v1.AddItemReply
	7,  // 12: cart.v1.Cart.UpdateItem:output_type -> cart.v1.UpdateItemReply
	9,  // 13: cart.v1.Cart.DeleteItem:output_type -> cart.v1.DeleteItemReply
...
func file_api_cart_v1_cart_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_cart_v1_cart_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_cart_v1_cart_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_cart_v1_cart_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
